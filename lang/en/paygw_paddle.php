...
$string['privacy:metadata:paygw_paddle_transactions'] = 'The Paddle payment gateway stores transaction records linked to each payer.';
$string['privacy:metadata:paygw_paddle_transactions:userid'] = 'The Moodle user ID of the payer.';
$string['privacy:metadata:paygw_paddle_transactions:component'] = 'The Moodle payment component (e.g. enrol_fee).';
$string['privacy:metadata:paygw_paddle_transactions:paymentarea'] = 'The Moodle payment area.';
$string['privacy:metadata:paygw_paddle_transactions:itemid'] = 'The Moodle item ID.';
$string['privacy:metadata:paygw_paddle_transactions:paddle_transaction_id'] = 'The Paddle transaction ID.';
$string['privacy:metadata:paygw_paddle_transactions:paddle_customer_id'] = 'The Paddle customer ID.';
...
$string['privacy:metadata:paygw_paddle_transactions:tax'] = 'The tax amount.';
...
$string['privacy:metadata:paygw_paddle_transactions:timemodified'] = 'The time the transaction was last modified.';
